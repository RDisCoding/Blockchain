...
contract RaffleTest is Test, CodeConstants {
    ...
    function setUp() external {
        ...
        (helperConfig, raffle) = deployer.deployContract();
    ...
    function testRaffleRevertsIfNotPaidEnoughToEnter() public {
        //Arrange
        vm.prank(PLAYER);
        //Act / Assert
    ...
    function testDontAllowPlayesToEnterWhileRaffleIsCalculating() public {
        //Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1); // Helps to simulate time passing using block.timestamp
